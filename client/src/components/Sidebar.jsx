  ...
  return (
    <aside className="fixed inset-x-0 top-0 z-30 border-b border-paper/10 bg-charcoal/95 backdrop-blur lg:inset-y-0 lg:left-0 lg:right-auto lg:w-72 lg:border-b-0 lg:border-r">
      <div className="flex h-full flex-col">
        <Link
          to="/"
          className="group relative block overflow-hidden border-b border-paper/10 p-5"
        >
          <img
            src={evidenceWall}
            alt=""
        ...
        <div className="hidden flex-1 flex-col gap-4 overflow-y-auto p-4 lg:flex">
          <div className="classified-panel">
            ...
            <p className="font-body text-sm leading-6 text-muted">
              NYC incident streams are scanned for paranormal, covert,
              underground, and anomalous signatures.
            </p>
          </div>

          {/* <EvidenceImagePlaceholder
            label="SIDEBAR CONSPIRACY POSTER"
            src={conspiracyImages.sidebarPoster}
            alt="Pinned conspiracy poster screenshot"
            // variant="portrait"
          /> */}
        </div>
      </div>
