  ...
  return (
    <div className="space-y-6">
      <section className="flex flex-col gap-3 border-b border-paper/10 pb-5 md:flex-row md:items-end md:justify-between">
        <div>
          <p className="font-body text-xs uppercase tracking-[0.28em] text-surveillance">Anomaly Analytics</p>
          <h2 className="mt-2 font-display text-6xl leading-none text-aged">Pattern Evidence Lab</h2>
        </div>
      ...
      {loading ? (
        ...
        <div className="grid gap-6 xl:grid-cols-2">
            ...
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={trend}>
                  ...
                  <Line type="monotone" dataKey="intensity" stroke="#00ff88" strokeWidth={2} dot={false} />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </ChartPanel>
          ...
          <ChartPanel title="Heat Intensity Chart" eyebrow="SIGNAL PRESSURE">
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
          ...
          <ChartPanel title="Conspiracy Activity Trends" eyebrow="INTENSITY OVERLAY">
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
