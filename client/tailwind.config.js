...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        evidence: '0 26px 80px rgba(0, 0, 0, 0.45), inset 0 0 0 1px rgba(184,169,143,0.12)',
      ...
      backgroundImage: {
        'paper-noise':
          'linear-gradient(145deg, rgba(184,169,143,0.18), rgba(10,10,10,0.04)), radial-gradient(circle at 30% 20%, rgba(193,18,31,0.14), transparent 30%)'
      }
    }
  },
  plugins: []
